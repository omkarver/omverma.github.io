...
<head>
    <title>Welcome</title>
    <link rel="stylesheet" type="text/css" href="css/stylewelcom.css">
</head>
<body>
    ...
    <main>
			...
			<div class="container">
				<?php echo "<h1>Welcome " . $_SESSION['username'] . " "." <h2>Thank you for registering yourself. Now you can add questions that will be redirected to quiz.</h2>". "</h1>"; ?>
				<div class="start">
